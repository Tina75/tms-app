<template>
  <div class="cube-has-bottom-btn cube-pt-10">
    ...
    <CheckboxPopup v-model="showPackageType" :value="model.unit" placeholder="请输入包装方式" @confirm="model.unit = $event"/>
...
export default {
  ...
  components: { FormItem, FromGroup, LoadingButton, CheckboxPopup },
  data() {
    return {
