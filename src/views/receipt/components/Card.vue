<template>
  <div class="tab-card">
    ...
    <div class="consignee-info border-bottom-1px">
      <div class="city">
        {{data.startName || data.consignerAddress | textOverflow}} <i class="iconfont icon-line cube-ml-5 cube-mr-5"/> {{data.endName || data.consigneeAddress | textOverflow}}
      </div>
    ...
    <div class="footer">
      ...
      <div class="right">
        ...
        <cube-button v-if="data.receiptOrder.receiptStatus === 1" :outline="true" :inline="true" :primary="!(data.receiptOrder.receiptStatus > 0)" :style="data.receiptOrder.receiptStatus > 0 ? {color: '#999', borderColor: '#999'} : {}" @click.stop="handleClick('backFactory')">返厂</cube-button>
